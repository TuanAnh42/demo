...
add_filter('jwt_auth_token_before_dispatch', function ($data, $user) {
	$data['user_role'] = $user->roles ? $user->roles[0] : 'subscriber';
	return $data;
}, 10, 2);
...
function render_contact_form_list()
{
	global $wpdb;
	$table = $wpdb->prefix . "contact_form";
	$results = $wpdb->get_results("SELECT * FROM $table ORDER BY created_at DESC");

	echo "<div class='wrap'><h1>Danh sách form đã gửi</h1>";
	echo "<table class='widefat'><thead><tr>
        <th>Tên</th><th>Phone</th><th>Address</th><th>Message</th><th>Ngày gửi</th>
    </tr></thead><tbody>";
...
// 1. Đăng ký Custom Post Type shop_order
